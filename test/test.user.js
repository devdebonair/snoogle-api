...
describe("Users", () => {
    ...
    describe("Multireddits", () => {
        it("should fetch", () => {
            return user.getMultireddits(getOptions().multireddits)
            .should.eventually.be.an("Array");
        });
    });
    ...
    describe("Subscriptions", () => {
        it("should fetch", () => {
            return user.getSubscriptions(getOptions().subscriptions)
            .should.eventually.be.an("Array");
        });
    });
    ...
    describe("Inbox", () => {
        ...
        it("should fetch comment replies", () => {
            return user.getCommentReplies()
            .should.eventually.be.an("Array");
        });

        it("should fetch submission replies", () => {
            return user.getSubmissionReplies()
            .should.eventually.be.an("Array");
        });
